        ...
        "items": [
                ...
                "children": [
                    {
                        ...
                        "desc": "Foundational and advanced model structures.",
                        "view": null,
                        "group": "ai",
                        "children": [
                            {
                    ...
                    },
                    {
                        ...
                        "desc": "General AI paradigms, fields, and phenomena",
                        "view": "list",
                        "group": "ai",
                        "children": [
                            {
                                ...
                                "links": [
                                    "rlhf#advanced variation hierarchical reinforcement learning (hrl)"
                                ],
                                "group": "ai",
                    ...
                    },
                    {
                        ...
                        "children": [
                            ...
                            },
                            {
                                ...
                                "group": "ai",
                                "content": "# AI Psychosis\n\nWhen financial markets or society at large experience sudden, severe panic and irrational behavior based solely on speculative, future-state predictions of AI capabilities, rather than current economic reality.\n\n**AI Psychosis** is a modern socio-economic phenomenon where the anxiety surrounding the future impact of artificial intelligence triggers highly disproportionate real-world consequences in the present out of sheer speculative fear.\n\nBecause the ultimate economic endpoint of mass AI adoption remains in a \"William Gibson zone\"; where the future is arriving but unevenly distributed; the financial system is intensely jittery. Even loosely substantiated thought experiments can trigger massive market selloffs.\n\n## The 2028 Global Intelligence Crisis (Alap Shah)\n\nA defining example of AI Psychosis occurred in early 2026. A financial analyst named Alap Shah and the research firm Citrini published a \"thought exercise\" titled *The 2028 Global Intelligence Crisis*.\n\nThe report predicted that by June 2028, mass adoption of [[agentic-ai|Agentic AI]] workflows would drive unemployment past 10%. The report theorized that when every consumer has access to dozens of personal AI agents, traditional \"rent-seeking\" middlemen and aggregators (like DoorDash or heavy logistics software) will be bypassed entirely by AI negotiating directly with suppliers.\n\nDespite intense criticism of the report's economic logic; and the fact that AI had not yet caused near-total labor substitution; its mere publication hit Wall Street with immense force, leading to an immediate 800-point drop in the Dow Jones as panicked investors dumped logistics and aggregator stocks out of pure future-state fear.\n\n## Key Themes\n\n*   **The Reverse Flywheel:** The core fear driving AI Psychosis is a negative economic loop: agents take jobs $\\rightarrow$ people have less money $\\rightarrow$ consumer spending drops $\\rightarrow$ corporations conduct further layoffs.\n*   **Vulnerability of Middlemen:** The market is most reactive to theories suggesting that [[agentic-ai|Autonomous Agents]] will achieve zero-friction direct contracting, entirely eliminating the need for app-based \"middlemen\" businesses.\n\n### Further Reading\n\n*   **Deep Dive Article:** *[WIRED: Wall Street Has AI Psychosis](https://www.wired.com/story/wall-street-has-ai-psychosis/)*\n*   **Related Concept:** *[[agentic-ai|Agentic AI]]*\n"
                            },
                            {
                                "id": "algorithmic-bias",
                            ...
                            },
                            {
                                ...
                                "group": "ai",
                                "content": "# Lethal Autonomous Weapons Systems (LAWS)\n\nGiving a drone a sniper rifle and permission to pull the trigger without ever asking a human first.\n\n**Lethal Autonomous Weapons Systems (LAWS)**; often controversially dubbed \"Slaughterbots\"; are military systems capable of independently searching for, identifying, and engaging targets using artificial intelligence and sensor data, entirely devoid of human intervention. \n\nThis marks a significant ethical departure from a traditional \"drone strike,\" where a human pilot sits in a trailer thousands of miles away and manually pushes a button to fire.\n\n## The Escalation Rationale \n\nWhy are militaries developing them? In modern cyber and electronic [[cyber-warfare|warfare]], communication links to remote human pilots are frequently jammed. To remain effective, drones must be able to make decisions locally. Furthermore, in hypersonic combat or drone swarms, human reaction times are simply too slow to compete against algorithmic speed. \n\n## The Ethical Red Lines\n\n1.  **The Accountability Gap:** If an autonomous drone misidentifies a school bus as an armored personnel carrier and strikes, who committed the war crime? The programmer? The commanding officer? The algorithm? If no human made the decision, traditional laws of armed conflict break down.\n2.  **Flash Wars:** If two opposing autonomous systems misinterpret each other's defensive maneuvers as aggressive, they could trigger a rapid, uncontrollable escalation to full conflict before human diplomats can even pick up the phone.\n3.  **Meaningful Human Control:** The international consensus among ethicists is that machines should never delegate the decision over human life to code. Life-and-death decisions require compassion, context, and moral reasoning, which an algorithm cannot possess.\n\n### Further Reading\n\n*   **Concept:** *[[cyber-warfare|Cyber Warfare]]*\n*   **Tech Component:** *[[computer-vision|Computer Vision]]*\n"
                            },
                            {
                                "id": "deepfakes",
                    ...
                    },
                    {
                        ...
                        "title": "Mechanisms",
                        "icon": "fas fa-cogs",
                        "desc": "Internal mathematical and structural components forming AI architectures.",
                        "view": null,
                        "group": "ai",
                        "children": [
                            {
                    ...
                    },
                    {
                        ...
                        "icon": "fas fa-plug",
                        "desc": "Universal standards and integrations for AI models",
                        "view": "shelf",
                        "group": "ai",
                        "children": [
                            {
                    ...
                    },
                    {
                        ...
                        "title": "Techniques",
                        "icon": "fas fa-tools",
                        "desc": "Applied methods, training paradigms, and engineering approaches in AI.",
                        "view": null,
                        "group": "ai",
                        "children": [
                            {
                ...
                "children": [
                    {
                        ...
                        "title": "Architecture",
                        "icon": "fas fa-sitemap",
                        "desc": "System design and software architecture patterns",
                        "view": "shelf",
                        "group": "devops",
                        "children": [
                            {
                    ...
                    },
                    {
                        ...
                        "icon": "fas fa-sync",
                        "desc": "Continuous Integration, Delivery, and Deployment pipelines",
                        "view": "list",
                        "group": "devops",
                        "children": [
                            {
                                "id": "production-cicd-pipeline",
                    ...
                    },
                    {
                        ...
                        "icon": "fas fa-box",
                        "desc": "Docker, Kubernetes, and Container Orchestration",
                        "view": "list",
                        "group": "devops",
                        "children": [
                            {
                    ...
                    },
                    {
                        ...
                        "icon": "fas fa-code",
                        "desc": "Automating infrastructure provisioning with code",
                        "view": "list",
                        "group": "devops",
                        "children": [
                            {
            ...
            },
            {
                ...
                "children": [
                    ...
                    },
                    {
                        ...
                        "icon": "fas fa-atom",
                        "desc": "Notes on Quantum Mechanics, Hardware, and Algorithms",
                        "view": "shelf",
                        "group": "general",
                        "children": [
                            {
                ...
                "children": [
                    {
                        ...
                        "children": [
                            ...
                            {
                                "id": "is-god-made-by-humans",
                                "title": "Is God Made by Humans?",
                                "icon": "far fa-file-alt",
                                "desc": "",
                                "tags": [
                                    "Philosophy",
                            ...
                            },
                            {
                                ...
                                "group": "philosophy",
                                "content": "# Universal Basic Services (UBS)\n\nInstead of giving everyone $1,000 to go buy their own water, food, and shelter on the private market, the government just provides the water, food, and shelter directly.\n\n**Universal Basic Services (UBS)** is a socioeconomic model advocating that essential human needs and services should be provided unconditionally, free at the point of need, to every member of a society. Driven by the philosophy of the \"commons,\" UBS shifts the focus from simply redistributing money (as seen in [[universal-basic-income|UBI]]) to directly democratizing access to the actual resources people need to survive and participate in modern society.\n\nWhile almost all developed nations already implement UBS to some degree; such as public schooling and universal healthcare; proponents of UBS argue that the definition of a \"basic service\" must be radically expanded for the 21st century.\n\n## Expanded Services\n\nA modern UBS framework typically argues that a functional, dignified life now requires free public access to:\n1.  **Housing:** Addressing the global housing affordability crisis through mass social housing programs.\n2.  **Transport:** Making local and regional bus and rail networks entirely fare-free, which simultaneously combats carbon emissions by reducing private car usage.\n3.  **Digital Inclusion:** Treating broadband internet infrastructure as a core utility, rather than a luxury, ensuring equitable access to online education, remote work, and telehealth.\n4.  **Food Programs:** Expansion of food-banks and public dining concepts to ensure basic caloric and nutritional baselines are met universally.\n\n## UBS vs. UBI\n\nUBS is frequently debated as either an alternative or a complementary system to [[universal-basic-income|Universal Basic Income]].\n\n*   **The Market Argument:** UBI relies on the free market; you give people money and trust that private companies will efficiently sell them the services they need. UBS proponents argue the free market routinely fails to provide affordable housing or healthcare, meaning rent and medical prices will simply inflate to consume whatever UBI is given.\n*   **The Efficiency Argument:** A centralized government can negotiate massive economies of scale (e.g., buying medicine in bulk for an entire nation), making it fundamentally cheaper and more efficient to provide the *service* directly rather than taxing people to hand out *money* to buy it linearly.\n*   **The Freedom Argument:** Critics of UBS argue it limits personal choice. UBI allows a citizen to decide exactly how they want to allocate their resources (perhaps they value travel over high-speed internet), whereas UBS forces a top-down, standardized allocation of resources that may not fit individual needs.\n\n### Further Reading\n\n*   **Article:** *[The Case for Universal Basic Services (UCL Institute for Global Prosperity)](https://www.ucl.ac.uk/bartlett/igp/news/2017/oct/igp-report-proposes-universal-basic-services-alternative-universal-basic-income)*\n*   **Article:** *[Universal Basic Income vs Universal Basic Services (New Economics Foundation)](https://neweconomics.org/2019/04/universal-basic-income-or-universal-basic-services)*\n"
                            }
                        ]
                    },
                    {
            ...
            },
            {
                ...
                "children": [
                    ...
                    {
                        "id": "psychology-concepts",
                        "title": "Psychology Concepts",
                        "icon": "fas fa-lightbulb",
                        "desc": "General psychology concepts",
                        "view": "list",
                        "group": "psychology",
                        "children": [
                            {
                            ...
                            },
                            {
                                ...
                                "links": [],
                                "group": "psychology",
                                "content": "# Types of Boredom\n\nBoredom isn't just one flavor of \"meh\"; it's a spectrum ranging from a relaxing sigh to an aggressive, desperate need to escape.\n\n**Types of Boredom** is a psychological framework that categorizes boredom into five distinct experiences based on two factors: how negative it feels (valence) and how physically restless or energetic it makes you in the moment (arousal).\n\n![types-of-boredom](https://media.springernature.com/full/springer-static/image/art%3A10.1007%2Fs11031-013-9385-y/MediaObjects/11031_2013_9385_Fig1_HTML.gif?as=webp)\n\nThink about being stuck in a waiting room. Sometimes you just stare blankly out the window, feeling relaxed and slightly tired. Other times, you are intensely frustrated, aggressively pacing the floor and wishing you could leave. Both are called \"boredom,\" but they feel completely different. Researchers discovered that boredom isn't a single emotion, but rather a collection of five distinct states characterized by your mental negativity and physical restlessness.\n\n## The Five Types of Boredom\n\n*   **Indifferent Boredom:** Low energy, slightly positive or neutral feeling. Characterized by relaxation, cheerful fatigue, and a general withdrawal from the external world. (Like staring at the ceiling in a peaceful daze).\n*   **Calibrating Boredom:** Low energy, slightly negative feeling. You feel mildly unpleasant with wandering thoughts. You're open to doing something else, but not actively looking to change your situation.\n*   **Searching Boredom:** Higher energy, more negative. You feel restless and actively search for alternative actions or thoughts, like hobbies or leisure, to minimize the boredom.\n*   **Reactant Boredom:** High energy, intensely negative. You feel severe restlessness and aggression with a strong motivation to escape the boredom-inducing situation (and often a desire to avoid whoever put you in it, like a teacher or boss).\n*   **Apathetic Boredom:** Low energy, intensely negative. You feel highly aversive, but completely lack the energy to do anything about it. It is strongly similar to learned helplessness or depression.\n\n![stages-of-boredom](https://media.springernature.com/full/springer-static/image/art%3A10.1007%2Fs11031-013-9385-y/MediaObjects/11031_2013_9385_Fig2_HTML.gif?as=webp)\n\n## FAQs\n\n*1. Which type of boredom is the most common?*\nCalibrating and searching boredom are the most typical, everyday forms of boredom. When most people imagine being \"bored,\" they are thinking of one of these two mid-level states.\n\n*2. Is apathetic boredom dangerous?*\nYes, apathetic boredom is particularly concerning for psychologists. Because of its mix of extreme negativity and complete lack of energy or drive, it closely resembles symptoms of depression or learned helplessness.\n\n### Further Reading\n\n*   **Article:** *[Types of boredom: An experience sampling approach](https://link.springer.com/article/10.1007/s11031-013-9385-y)* (The original research paper from Goetz and Frenzel outlining this five-class model of emotional boredom).\n"
                            }
                        ]
                    }
                ]
            },
            {
                ...
                "children": [
                    ...
                    },
                    {
                        ...
                        "icon": "fas fa-microchip",
                        "desc": "Theoretical foundations of computing and information",
                        "view": "shelf",
                        "group": "science",
                        "children": [
                            {
                                ...
                                "desc": "Automata, formal languages, and computability",
                                "view": "shelf",
                                "group": "science",
                                "children": [
                                    {
                    ...
                    },
                    {
                        ...
                        "children": [
                            ...
                            },
                            {
                                ...
                                "desc": "Methods for analyzing relationships",
                                "view": "list",
                                "group": "science",
                                "children": [
                                    {
                                        "id": "chatterjees-correlation",
                            ...
                            },
                            {
                                ...
                                "icon": "fas fa-vial",
                                "desc": "Hypothesis and significance tests",
                                "view": "list",
                                "group": "science",
                                "children": [
                                    {
